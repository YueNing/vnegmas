...
from negmas.apps.scml.schedulers import Scheduler, ScheduleInfo, GreedyScheduler
from negmas.helpers import get_class
from negmas.outcomes import Issue, Outcome
from negmas.apps.scml.common import SCMLAgreement, Factory, INVALID_UTILITY, CFP, Loan, ProductionFailure, FinancialReport
...
from negmas.apps.scml.consumers import ScheduleDrivenConsumer, ConsumptionProfile
from negmas.apps.scml.awi import _ShadowSCMLAWI, SCMLAWI
...
class MyFactoryManager( DoNothingFactoryManager):
    ...
    def confirm_contract_execution(self, contract: Contract) -> bool:
        ...
        # # TODO random return true confirm contract execution 
    ...
    def __init__(self,  log_file_name=None,screen_log=False, name=None, simulator_type: Union[str, Type[FactorySimulator]] = FastFactorySimulator
                 , scheduler_type: Union[str, Type[Scheduler]] = GreedyScheduler
                 , scheduler_params: Optional[Dict[str, Any]] = None
                 , optimism: float = 0.0
                 , negotiator_type: Union[str, Type[Negotiator]] = 'backend.src.nnegmas.my_mechanism.MyTestNegotiator'
                 ...
                 , riskiness=0.0, max_insurance_premium: float = 0.1):
...
class NegotiatorUtility(UtilityFunction):
    ...
    def __init__(self, agent: MyFactoryManager, annotation: Dict[str, Any], name: Optional[str] = None):
        if name is None:
